package com.project.onboard.config;

import com.project.onboard.domain.security.JwtFilter;
...
//                .antMatchers(HttpMethod.GET, "/user", "/user/info/*").hasAuthority("read")
                .antMatchers("/onboard/*").hasAnyAuthority("User")
